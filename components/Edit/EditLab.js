...
import labs from '../../json/labs.json';
const EditLab=({route,navigation})=>{
  ...
  buttontxt= route.params.buttontxt
    ...
    const labname = route.params.selectedlab;
    ...
    >
      ...
      <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
        ...
        <Button title="Submit" onPress={()=>{
            labs[labname][day].push({"name":name,"start":from,"end":to,"subject":subject})
        ...
        <TouchableOpacity style={styles.back}><Text style={styles.backtxt}
            ...
            <Text style={[styles.sign,{color:buttontxt}]}>Edit Lab</Text>

            <TextInput style={[styles.input,{color:buttontxt,borderBottomColor:buttontxt}]} placeholder='Enter Lab Name' placeholderTextColor={"#9C9FA6"}
      ...
      {day !== '' &&
        (labs[labname][day].length==0 ? (
            
          <Text style={[styles.buttontxt,{color:buttontxt}]}>No labs today</Text>
          
        ) : (
          labs[labname][day].map((data) => (
      ...
      <View style={styles.container3}>
        <TouchableOpacity style={styles.optionbuttons} onPress={()=>labs[labname][day].pop()}><Text style={styles.optionstxt}>Remove</Text></TouchableOpacity>
