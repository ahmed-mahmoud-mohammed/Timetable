...
const DeleteUser=({navigation,route})=>{
  color = route.params.color
    ...
    return(
        ...
        <View  style={[styles.container,{backgroundColor:color}]}>
          <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
            ...
            <Text style={[styles.sign,{color:buttontxt}]}>Delete User</Text>
           
            <TextInput style={[styles.input,{color:buttontxt,borderBottomColor:buttontxt}]} placeholder='Enter ID' placeholderTextColor={"#9C9FA6"}
    ...
    if(id===""){
      ...
      const response = fetch(`https://delicate-resonance-6870.fly.dev/api/users/${id}`, {
            method: 'Delete',
            headers: {
