...
const AddHall=({navigation,route})=>{
  ...
  const [modalVisible2,setModalVisible2]= useState(true) 
    ...
    >
      ...
      <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
        ...
        <Text style={{color:buttontxt,fontWeight:"bold",fontSize:20,alignSelf:"center"}}>Hall Name</Text>
        <TextInput
          style={[styles.input,{color:buttontxt,borderBottomColor:buttontxt}]}
          onChangeText={setHallName}
          value={hallname} placeholder='Enter Hall Name' placeholderTextColor={"#9C9FA6"}
        />
        
        <Button title="Submit" onPress={()=>{
            table[hallname]= {"Saturday":[],"Sunday":[],"Monday":[],"Tuesday":[],"Wednesday":[],"Thursday":[]}
    ...
    >
      ...
      <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
        ...
        />
        <Button title="Submit" onPress={()=>{
            table[hallname][day].push({"name":name,"start":from,"end":to,"subject":subject})
        ...
        <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
            ...
            <Text style={[styles.sign,{color:buttontxt}]}>Add Hall</Text>
      ...
      {day !== '' &&
        (table[hallname][day].length==0 ? (
            
          <Text style={[styles.buttontxt2,{color:buttontxt}]}>No Lectures Today</Text>
          
        ) : (
          table[hallname][day].map((data) => (
      ...
      <View style={styles.container3}>
        <TouchableOpacity style={styles.optionbuttons} onPress={()=>{day!==""?table[hallname][day].pop():setErr("Select a Day")}}><Text style={styles.optionstxt}>Remove</Text></TouchableOpacity>
