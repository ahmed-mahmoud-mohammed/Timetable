  ...
  const [modalVisible2,setModalVisible2]= useState(true) 
    ...
    >
      ...
      <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
        ...
        <Text style={{color:buttontxt,fontWeight:"bold",fontSize:20,alignSelf:"center"}}>Lab Name</Text>
        <TextInput
          style={[styles.input,{color:buttontxt,borderBottomColor:buttontxt}]}
          onChangeText={setLabName}
          value={labname} placeholder='Enter Lab Name' placeholderTextColor={"#9C9FA6"}
        />
        
        <Button title="Submit" onPress={()=>{
            table[labname]= {"Saturday":[],"Sunday":[],"Monday":[],"Tuesday":[],"Wednesday":[],"Thursday":[]}
    ...
    >
      ...
      <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
        ...
        />
        <Button title="Submit" onPress={()=>{
            table[labname][day].push({"name":name,"start":from,"end":to,"subject":subject})
        ...
        <TouchableOpacity style={styles.back}><Text style={[styles.backtxt,{color:buttontxt}]}
            ...
            <Text style={[styles.sign,{color:buttontxt}]}>Add Lab</Text>
      ...
      <View style={styles.container3}>
        <TouchableOpacity style={styles.optionbuttons} onPress={()=>{day!==""?table[labname][day].pop():setErr("Select a Day")}}><Text style={styles.optionstxt}>Remove</Text></TouchableOpacity>
